...
//	private LinearLayout llAt;
	...
	private RelativeLayout getPageView() {
		...
		rlPage.setBackgroundResource(R.drawable.title_back);
		return rlPage;
	}
	//这里可以更改分享界面字体大小更改最上方返回等
	// title bar 
...
//		}
		...
		if (resId > 0) {
			...
			llTitle.getBtnRight().setTextSize(20);
		}
