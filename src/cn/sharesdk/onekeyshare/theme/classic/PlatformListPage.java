...
import com.qiao.sharesdkallshare.R;
...
public class PlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	...
	private void initPageView() {
		...
		grid.setBackgroundResource(R.drawable.btn_back_nor);
		llPage.addView(grid);
		...
		btnCancel.setBackgroundResource(R.drawable.btn_back_nor);
		llPage.addView(btnCancel);
		llPage.setBackgroundResource(R.drawable.btn_back_nor);
	}
